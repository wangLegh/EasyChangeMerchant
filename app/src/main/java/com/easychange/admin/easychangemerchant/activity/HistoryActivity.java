 ...
 * admin  2018/8/16 wan
 */
public class HistoryActivity extends BaseActivity implements OnLineAdapter.OnItemClickListener, WanRecyclerView.PullRecyclerViewCallBack, View.OnClickListener {
    ...
    public void onItemClickListener() {
        HistoryDetailsActivity.invoke(this);
    }
